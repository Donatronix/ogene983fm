                    ...
                    <div class="container">
                        <form action="{{ route('post.update', ['post' => $post->slug]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="summary" class="form-control" id="summary" rows="3" style="resize:none;">{{ old('summary', $post->about) }}</textarea>
                                @error('summary')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" class="form-control ckeditor" id="content" rows="3" style="resize:none;">{{ old('content', $post->content) }}</textarea>
                                @error('content')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('category', $categories, old('category', $post->category->id), ["class" => "form-control", 'required' =>'']) !!}
                                @error('category')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <img src="{{ $post->cover_image }}" alt="" class="img-thumbnail">
                                    </div>
                                    <div class="col-md-8">
                            ...
                            <div class="tile-footer">
                                ...
                                <a class="btn btn-danger pull-right" href="{{ route('post.dashboard') }}">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
